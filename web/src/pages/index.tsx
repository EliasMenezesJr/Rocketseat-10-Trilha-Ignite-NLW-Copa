...
export default function Home({ poolCount, guessCount, userCount }: HomeProps) {
  ...
  async function createPoll(event: FormEvent){  
    ...
    try {
      ...
      alert(`Bolão criado com sucesso! O código do seu bolão foi copiado para a área de transferência.\n ${code}`)
      setPoolTitle('')
    } catch (error) {
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <div className="mt-10 pt-10 border-t border-gray-600 flex text-gray-100 justify-between intems-center">
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo uma prévia aplicação móvel do NLW Copa"
      />
    </div>
  );
}
